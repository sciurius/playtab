...
package App::Music::PlayTab::Output::iRealPro;

# Author          : Johan Vromans
# Created On      : Mon Apr 29 10:53:55 2013
# Last Modified By: Johan Vromans
# Last Modified On: Mon Jan 19 15:11:29 2015
# Update Count    : 178
...
sub new {			# API
    ...
    # ::iRealPro::Perl generates a Perl program that uses the
    # iRealPro modules to generate iRealPro data, but that can be
    # modified after generation for specific purposes beyond the scope
    # of PlayTab.
    # ::iRealPro::Song is similar to Perl, but uses the more friendly
    # Song API.
    # The decision what backend to use is based on the name of the
    # generator, so we're not supposed to come here.

    use Carp qw(croak);
    croak("You're not supposed to come here");
}
